...
var numFiveInNumber = +numFive;       // using + string convert into number
...
// var result = +n3; 
console.log(`Value : ${result} and it's type: ${ typeof resu}`);
...
// use of '+' operator is - 
// 1- adding two number 
//2- concating two string
// 3- convert string into number data type is number